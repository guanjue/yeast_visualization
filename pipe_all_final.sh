...
#rm -r /Volumes/MAC_Data/data/labs/pugh_lab/test_pipeline_final/box_ref/
#mkdir /Volumes/MAC_Data/data/labs/pugh_lab/test_pipeline_final/box_ref/
while read info; do
	...
	cp *_image_*.bed /Volumes/MAC_Data/data/labs/pugh_lab/test_pipeline_final/box_ref/
	cp *_image_*.png /Volumes/MAC_Data/data/labs/pugh_lab/test_pipeline_final/box_ref/
	cp *_image_*.txt /Volumes/MAC_Data/data/labs/pugh_lab/test_pipeline_final/box_ref/
	rm *bam

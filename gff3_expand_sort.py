...
def gff3_expand_sort(file_name,upstream_expan,downstream_expan,roman2arabic_tf,outputname):
...
def main(argv):
	...
	gff3_expand_sort(file_name, upstream_expan, downstream_expan, roman2arabic_tf,outputname)
